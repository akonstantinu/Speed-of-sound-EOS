...
void grief(){
  ...
  //Loop for EOS
  while(fileNum<num){
    double e0=rand->Uniform(1.,3.)*TMath::Power(10,15); /* kappa*G/(c*c) *///central energy density
    ...
    a1=1.41193;//rand->Uniform(0.1,1.5);
    a2=5.90879;//rand->Uniform(1.5,12);
    a3=3.38331;//rand->Uniform(0.05*a2,2*a2);
    a4=22.6653;//rand->Uniform(1.5,37);
    a5=0.804284;//rand->Uniform(0.1,1);
